...
export function InputCheckbox(props: PropsInput) {
  //* use either defaultChecked or checked *//
  let sx_props = {}
  sx_props = props.checkSize ? { ...sx_props, '& .MuiSvgIcon-root': { fontSize: props.checkSize } } : sx_props
  ...
  return (
    <Grid item xs={props.xs || 12}>
      <Controller
        control={props.control}
        name={props.name}
        defaultValue={!!props.defaultChecked || !!props.checked ? true : false}
        render={({ field: { onChange, onBlur, value, ref }, fieldState: { error } }) => (
          <FormControlLabel
            control={
              <Checkbox
